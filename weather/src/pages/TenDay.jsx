...
function TenDay({ location }) {
    ...
    return (
      <div className="container">
        <div className="empty-state">
          ...
          <p>Enter a location to see the 10-day weather forecast</p>
        </div>
      </div>
    )
  }
  ...
  if (loading) {
    return (
      <div className="container">
        <div className="loading">Loading 10-day forecast...</div>
      </div>
    )
  }
  ...
  return (
    <div className="container">
      <h1 className="section-title">10-Day Forecast for {weather.location}</h1>
      ...
      <div className="card" style={{ marginTop: '32px' }}>
        <h3 style={{ marginTop: 0 }}>Extended Forecast Information</h3>
        <p style={{ color: 'var(--muted)', lineHeight: '1.6' }}>
          This 10-day forecast provides a general outlook for weather conditions in {weather.location}.
          The forecast accuracy typically decreases after the first 3-4 days. Check back regularly for
